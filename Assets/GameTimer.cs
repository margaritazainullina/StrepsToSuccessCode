...
public class GameTimer : MonoBehaviour
{
	...
	{ 
				...
				date = DateTime.Now;
		gameDate = new DateTime (2015,5,17,12,0,0);
	}
	// Use this for initialization
	void Start ()
	{
		NotificationCenter.getI.addCallback("CharacterCoordinates", this.PrintCoordinates);
	}
	...
	public static String getDisplayTime(){
		return gameDate.ToShortDateString()+" "+gameDate.ToShortTimeString();
	}
	...
	private void PrintCoordinates(object sender){
		Transform t = (Transform)sender;
		Debug.Log("Coordinates: "+ t.position.x+", "+t.position.y);
	}
}

...
{
		public static void SaveGameToDB (MySqlConnection connection)
		{
				/****************SAVING - UPDATE DATA*****************************/
		...
		public static void LoadGameFromDB (MySqlConnection connection)
		{
				/*****************LOADING THE GAME***********************/
		...
		public static bool SaveDataToFile (FileStream fs)
		{
		...
		public static bool LoadDataFromFile (FileStream fs)
		{
				IFormatter bform = new BinaryFormatter ();
